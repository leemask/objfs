...
typedef int (*fn_diskio_read_byte) (uint32 addr, uint8 *buffer, uint32 length_b);
typedef int (*fn_diskio_write_byte)(uint32 addr, uint8 *buffer, uint32 length_b);
// ------------------------------------------------------------------------
...
// ieroa@elixirflash.com---------------------------------------------------	
	fn_diskio_read_byte		read_byte_media;
	fn_diskio_write_byte	write_byte_media;
// ------------------------------------------------------------------------
