...
public:
	...
	int disk_erase(uint32_t sector, uint32_t count);
	int disk_send_status(uint32_t wait_ms);
	struct mmc_cid* get_cid();
...
private:
    ...
    enum Command {
		...
		CMD32 = (0x40 | 32),     /**< ERASE_GROUP_START */
		CMD33 = (0x40 | 33),     /**< ERASE_GROUP_END */
		CMD38 = (0x40 | 38)     /**< ERASE */
    };
